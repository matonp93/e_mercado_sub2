...
const productosRelacionados =
  document.getElementsByClassName("related-products")[0];
const comentariosSection = document.getElementsByClassName(
...
function ResetearColores() {
  ...
  Array.from(document.getElementsByTagName("object")).forEach((element) => {
    ...
    element.contentDocument.getElementsByTagName("svg")[0].style.color =
      colores[contador];
    contador++;
  });
}
